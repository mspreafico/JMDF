#############################################################################
# Joint frailty model with bivariate Gaussian random effects proposed in
# Ng et al. (2023); https://doi.org/10.1093/biostatistics/kxab037 
# This function is taken from https://github.com/RichardTawiah/JointFrailty
#############################################################################

library(dplyr)

joint.frailty.Ng<-function(dat,patient,theta01,theta02,rho0,itmax){
  ...
  flag<-0 #changed flag.var to flag
  eps.reg<-0.0001
  eps.var<-0.01
