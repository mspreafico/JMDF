...
table1$Estimate <- round(table1$Estimate, digits = 3)
table1$StdDev <- round(table1$StdDev, digits = 3)
table1$pvalue <- ifelse(
  table1$pvalue < 2e-16,
  "<2e-16",
  formatC(table1$pvalue, format = "e", digits = 2)
)
...
# Figure 6 #
#----------#
# We compare the results reported by Rondeau et al. and Ng et al. with
# those obtained using the JMDF "gauss3" model (JMDF with Gaussian
# initialization and L = 1), generated by "02_main_JMDF.R".
